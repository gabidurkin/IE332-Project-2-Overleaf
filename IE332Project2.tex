...
Verification is the process of checking whether the attack algorithm meets the specifications or requirements. Here we discuss how the five algorithms are weighted and combined into one main adversarial attack on the provided grass/dandelion classifier to fool it into incorrectly classifying the image by under 50\%. When doing a static analysis of the algorithm, a method of verifying code correctness by analyzing the code without running it XXX. 
\subsection{Runtime,
Complexity, and Walltime}
\subsubsection{Runtime}
\subsubsection{Complexity}
\subsubsection{Walltime}
The walltime of the algorithm refers to the actual time elapsed from the start to theend of the algorithm execution. Walltime is an important performace metric 
...
\section{References}
\begin{enumerate}
    \item Pavel Tyshevskyi. (2019, September 28). Adversarial Attack Using Genetic Algorithm - Analytics Vidhya - Medium. Medium; Analytics Vidhya. https://medium.com/analytics-vidhya/adversarial-attack-using-genetic-algorithm-90beba13b6cb
    \item Rok Kukovec , Pecnk, S., Iztok Fister jr, & Sašo Karakatič. (2021, September 13). Adversarial Image Perturbation with a Genetic Algorithm. ResearchGate; unkown. https://www.researchgate.net/publication/354557862_Adversarial_Image_Pertubation_with_a_Genertic_Algorithm
    \item VisibleBreadcrumbs. (2023). Mathworks.com. https://www.mathworks.com/help/gads/what-is-particle-swarm-optimization.html
    \item Wang, D., Tan, D., Liu, & Liu, L. (n.d.). Particle swarm optimization algorithm: an overview. https://kpfu.ru/staff_files/F_1407356997/overview.pdf
