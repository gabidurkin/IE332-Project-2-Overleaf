...
The complexity of adversarial attacks refers to the amount of computational resources, time, and effort required to generate adversarial examples that can effectively trick machine learning models. It is a measure of how difficult it is to perform an attack and how much computational power is needed to create effective adversarial examples. The complexity of our adversarial attack algorithm that uses genetic algorithm, particle swarm optimization, simulated annealing, hill climbing, and fast gradient sign method depends on various factors. Generally speaking, the complexity of these algorithms is high because they are iterative and have a large number of possible solutions. Genetic algorithm and particle swarm optimization are computationally expensive as they require evaluating each pixel of an image looking for the most optimal solution. Simulated annealing and hill climbing methods are less complex as they evaluate neighboring solutions in order to find the optimal solution, meaning they most likely will not evalu
...
Using the scoring equation, $\sum_{n=$ where 
